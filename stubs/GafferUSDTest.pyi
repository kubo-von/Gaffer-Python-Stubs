...
def USDAttributesTest (*args):
      '''

'''      
    ...

class USDAttributesTest:
...
def USDLayerWriterTest (*args):
      '''

'''      
    ...

class USDLayerWriterTest:
    def _SceneTestCase__formatPaths (self, path1, path2):
      '''None'''
    ...
    def _SceneTestCase__pathToString (self, path):
...
dict(**kwargs) -> new dictionary initialized with the name=value pairs
    ...
    def _TestCase__undocumentedPlugs (self, node, additionalTerminalPlugTypes=()):
      '''None'''
    ...
    def _USDLayerWriterTest__writeLayerAndComposition (self, base, layer):
      '''None'''
    ...
    def _addExpectedFailure (self, result, exc_info):
      '''None'''
...
dict(**kwargs) -> new dictionary initialized with the name=value pairs
    ...
    def _TestCase__undocumentedPlugs (self, node, additionalTerminalPlugTypes=()):
      '''None'''
    ...
    def _USDShaderTest__assertShaderLoads (self, name, expectedParameters, expectedOutputs):
      '''None'''
    ...
    def _addExpectedFailure (self, result, exc_info):
      '''None'''
