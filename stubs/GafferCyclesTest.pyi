...
def CyclesLightTest (*args):
      '''

'''      
    ...

class CyclesLightTest:
...
def CyclesShaderTest (*args):
      '''

'''      
    ...

class CyclesShaderTest:
    def _SceneTestCase__formatPaths (self, path1, path2):
      '''None'''
    ...
    def _SceneTestCase__pathToString (self, path):
...
def IECoreCyclesPreviewTest (*args):
      '''

'''      
    ...

def InteractiveCyclesRenderTest (*args):
      '''

'''      
    ...

class InteractiveCyclesRenderTest:
...
class RendererTest:
    def _RendererTest__colorAtUV (self, image, uv, channelName=''):
      '''None'''
    ...
    def _RendererTest__testCustomAttributeType (self, primitive, prefix, customAttribute, outputPlug, data, expectedResult, maxDifference=0.0):
      '''None'''
    ...
    def _RendererTest__testMeshSmoothing (self, cube, smoothingExpected):
      '''None'''
    ...
    def _RendererTest__testPrimitiveVariableInterpolation (self, primitive, primitiveVariable, expectedPixels, maxDifference=0.0, attributeName=None):
      '''None'''
    ...
    def _RendererTest__testShaderResults (self, shader, expectedResults, maxDifference=0.0):
      '''None'''
    ...
    def _RendererTest__valueAtUV (self, image, uv, channelName):
      '''None'''
    ...
    def _TestCase__nodeHasDescription (self, node):
      '''None'''
...
def ShaderNetworkAlgoTest (*args):
      '''

'''      
    ...

class ShaderNetworkAlgoTest:
    def _ShaderNetworkAlgoTest__assertShadersEqual (self, shader1, shader2, message=None):
      '''None'''
    ...
    def _addExpectedFailure (self, result, exc_info):
      '''None'''
