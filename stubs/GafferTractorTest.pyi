...
def TractorDispatcherTest (*args):
      '''

'''      
    ...

class TractorDispatcherTest:
    def _TestCase__nodeHasDescription (self, node):
      '''None'''
    ...
    def _TestCase__undocumentedPlugs (self, node, additionalTerminalPlugTypes=()):
      '''None'''
    ...
    def _TractorDispatcherTest__dispatcher (self):
      '''None'''
    ...
    def _TractorDispatcherTest__job (self, nodes, dispatcher=None):
      '''None'''
    ...
    def _addExpectedFailure (self, result, exc_info):
      '''None'''
